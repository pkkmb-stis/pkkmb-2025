...
<body class="antialiased font-mulish" x-data="{ openDropdown: false, openSidebar: false }">
    ...
    <div class="block w-screen h-screen grid-cols-9 grid-rows-6 overflow-y-auto md:grid custom-scroll">
        ...
        <div class="fixed w-full col-span-3 row-span-1 md:flex md:relative md:w-auto lg:col-span-2 bg-background1-pattern">
            <div class="w-full md:mt-10 md:ml-10 md:rounded-tl-3xl bg-background1-pattern md:bg-none bg-2025-1">
                @include('admin._partials.topbar-hp')
            </div>
        </div>

        <div class="col-span-6 row-span-1 md:flex pt-14 md:pt-0 lg:col-span-7 bg-background1-pattern">
            <div class="w-full bg-white md:mt-10 md:mr-10 md:rounded-tr-3xl bg-opacity-60">
                @include('admin._partials.topbar-pc')
            </div>
        </div>

        <div class="fixed w-full col-span-3 row-span-5 -mt-1 overflow-y-auto border-2 border-t-0 md:flex md:relative md:w-auto h-96 md:h-auto lg:col-span-2 bg-background1-pattern custom-scroll border-b-black border-x-black md:border-none rounded-bl-3xl rounded-br-3xl md:rounded-none"
        ...
        <div class="col-span-6 row-span-5 -mt-1 md:flex lg:col-span-7 bg-background1-pattern custom-scroll">
            <div
