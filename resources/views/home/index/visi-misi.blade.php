<div class="max-w-full overflow-hidden mix-blend-multiply">
  ...
  <img src="img/asset/2025/elemen.png" alt="ornamen kanan" 
    ...
    <div class="py-8 px-4">
      <div class="bg-[#8B2F4B] text-white px-6 py-8 rounded-2xl relative text-center shadow-lg">
        <div class="z-0 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-cover opacity-[20%]"
             style="background-image: url('img/asset/2025/timeline/patternwait1.png'); background-position: center; width:70%; height:100%; ">
        </div>
    ...
    <div class="py-6 px-4 overflow-hidden max-w-full">
      <div class="bg-[#8B2F4B] text-white px-6 py-8 rounded-2xl relative shadow-lg overflow-hidden">
        ...
        <h2 class="text-center text-lg font-semibold mb-4 font-chaTime tracking-widest relative z-10">MISI:</h2>
  ...
  <div class="hidden lg:block">
    ...
    <div class="py-10 lg:pb-20">
      <div class="flex flex-row mx-auto w-full justify-center items-stretch mb-8 px-12" data-aos="fade-right">
