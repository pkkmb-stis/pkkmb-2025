...
<footer class="fill-current text-base-white bg-footer-solid bg-putih2-pattern px-8">
    <div class="block lg:flex justify-between items-start border-b-8 border-base-yellow-600 text-base-grey-100 py-8 px-2">
        ...
        <div class="w-[90%] lg:w-[30%] mx-2 mb-4 lg:mb-0">
            <h1 class="font-semibold lg:text-2xl md:text-xl text-lg leading-9 font-poppins  space-x-4 text-base-white text-center">
        ...
        <div class="w-[90%] lg:w-[30%] mx-2">
            ...
            <div class="flex w-full h-fit items-center gap-2 my-4 hover:text-kuning-600">
                <a target="_blank" href="https://mail.google.com/mail/u/0/?view=cm&fs=1&tf=1&to=pkkmb@stis.ac.id&subject=MISSED%20CALL%20EZTRADER&body=" class="transition font-bold h-10 w-10 hover:text-kuning-600 flex items-center justify-center">
    ...
    <p class="justify-center text-center mt-6 text-white lg:text-lg md:text-base text-sm pb-4">Copyright &copy;
        &bull; Seksi GRAMTI PKKMB-PKBN 2024 Politeknik
        Statistika STIS</p>
</footer>
<!-- End Footer -->
