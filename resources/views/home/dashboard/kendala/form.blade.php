                ...
                <form wire:submit.prevent="submit" class="text-sm text-gray-700">
                    ...
                    <div class="grid lg:grid-cols-2 lg:gap-6">
                        <div class="mb-3">
                            ...
                            <x-select-form wire:model.defer="category" id="category">
                        ...
                        <div class="mb-3">
                            ...
                            <x-date-input wire:model.defer="waktuKendala" id="waktuKendala" name="waktuKendala" />
                    ...
                    <div class="mb-3">
                        ...
                        <x-textarea name="content" wire:model.defer="content" id="content" cols="30"
                            rows="5">
                        </x-textarea>
