    ...
    @if ($berita)
        <div x-cloak x-show="showModalBerita">
            <x-modal.berita judul="{{ $berita->judul }}" image="{{ storage($berita->thumbnails) }}">
                <x-slot name="icon">
                    <div class="mr-1 flex items-center justify-center text-center">
                    ...
                    <div class="mx-1 flex items-center justify-center text-center">
                    ...
                    <div class="ml-1 flex items-center justify-center text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div class="ql-editor text-gray-50" x-effect="$el.innerHTML = '{{ $berita->content }}'"></div>
