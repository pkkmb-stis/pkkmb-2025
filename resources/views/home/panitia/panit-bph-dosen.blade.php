<div class="flex w-47/100 items-center justify-center md:w-1/3 lg:w-2/9 md:flex-col">
    <div class="flex relative z-10 h-auto w-full">
        ...
        <div class="flex flex-col justify-between bg-merah-2 rounded-tr-lg rounded-br-lg">
            ...
            @endphp
            @if(count($words) == 2 && $m['jabatan'] !== "Wakil Ketua")
                <div class="triangle-top-long"></div>
                <div class="flex justify-between">
                    <div class="self-center flex font-bohemianSoul text-center text-[9px] text-white sm:text-base md:text-[11px] lg:text-[10px] xl:text-xs text-jabatan pl-1 xl:pl-2 ">
                        <h1 class="verticaltext z-10 text-center leading-normal">
                            {{ $words[0] }}
                        </h1>
                    </div>
                    <div class="self-center flex font-bohemianSoul text-center text-[9px] text-white sm:text-base md:text-[11px] lg:text-[10px] xl:text-xs text-jabatan pr-1 xl:pr-2 ">
                        <h1 class="verticaltext z-10 text-center leading-normal">
                            {{ $words[1] }}
                        </h1>
                    </div>
            ...
            @else
                <div class="triangle-top-long"></div>
                <div class="self-center flex font-bohemianSoul text-center text-[10px] text-white sm:text-base md:text-[11px] lg:text-[8px] xl:text-xs text-jabatan px-1 xl:px-2 ">
