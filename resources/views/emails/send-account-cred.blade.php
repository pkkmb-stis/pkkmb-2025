                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell">
                                        ...
                                        {{ Illuminate\Mail\Markdown::parse('Harap perhatikan petunjuk penting berikut: ') }}
                                        {{ Illuminate\Mail\Markdown::parse('<b>1. Pergantian Kata Sandi</b>') }}
                                        {{ Illuminate\Mail\Markdown::parse('Setelah pertama kali masuk, Kami menyarankan Anda untuk mengubah kata sandi yang lebih kuat dan unik untuk menjaga keamanan akun Anda di halaman profil.') }}
                                        {{ Illuminate\Mail\Markdown::parse('<b>2. Kerahasiaan</b>') }}
                                        {{ Illuminate\Mail\Markdown::parse('Pastikan Anda tidak membagikan kredensial login Anda kepada siapapun.') }}
                                        {{ Illuminate\Mail\Markdown::parse('<b>3. Dukungan Teknis</b>') }}
                                        {{ Illuminate\Mail\Markdown::parse('Jika Anda mengalami masalah selama proses login atau membutuhkan bantuan, jangan ragu untuk menghubungi Seksi Gramti melalui email ke <a href="mailto:gramti-pkkmb@stis.ac.id">gramti-pkkmb@stis.ac.id</a>.') }}
