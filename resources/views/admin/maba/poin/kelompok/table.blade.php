    ...
    <div>
        ...
        <x-card class="mb-8">
            ...
            <div class="grid lg:grid-cols-2 lg:gap-6">
                <div class="mb-3">
                    <x-date-wo-time-input wire:model.blur="tanggal_poin_kelompok" id="tanggal_poin_kelompok"
            ...
            <div class="grid lg:grid-cols-1 lg:gap-6">
                <div class="mb-3">
                    <x-input wire:model.live.debounce.200ms="search" type="text" placeholder="Cari kelompok"
