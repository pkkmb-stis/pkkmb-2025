            ...
            <div class="grid mb-8 sm:grid-cols-2 sm:gap-6 gap-y-6">
              <div>
                ...
                <div class="mb-3">
                  ...
                  <x-select-form wire:model.defer="is_pasca" id="is_pasca">
                ...
                <div class="mb-3">
                  ...
                  <x-textarea name="caption" wire:model.defer="caption" id="caption" cols="30" rows="8">
                  </x-textarea>
              ...
              <div>
                <div class="mb-3">
                  ...
                  <x-textarea name="link" wire:model.defer="link" id="link" cols="30" rows="4">
                  </x-textarea>
                ...
                <div class="mb-3">
                  ...
                  <x-textarea name="link_lambat" wire:model.defer="link_lambat" id="link_lambat" cols="30"
                    rows="4">
                  </x-textarea>
                ...
                <div class="mb-3">
                  ...
                  <x-date-input wire:model.defer="waktu_mulai" id="waktu_mulai" name="waktu_mulai" />
                  <x-error-input name="waktu_mulai" />
                </div>

                <div class="mb-3">
                  <x-label-input for="waktu_akhir">Waktu Akhir Absensi</x-label-input>
                  <x-date-input wire:model.defer="waktu_akhir" id="waktu_akhir" name="waktu_akhir" />
