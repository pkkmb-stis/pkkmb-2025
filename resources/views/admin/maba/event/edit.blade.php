        ...
        <div class="grid mb-8 sm:grid-cols-2 sm:gap-6 gap-y-6">
          <div>
            ...
            <div class="mb-3">
              ...
              <x-select-form wire:model="is_pasca" id="is_pasca2">
            ...
            <div class="mb-3">
              ...
              <x-textarea name="caption" wire:model="caption" id="caption2" cols="30" rows="8">
              </x-textarea>
