...
class Add extends Component
{
    ...
    public function submit()
    {
        ...
        if (!userHasPermission(PERMISSION_ADD_EVENT))
            $this->dispatchBrowserEvent('updated', ['title' => 'Kamu tidak memiliki akses untuk menambah acara absensi', 'icon' => 'error', 'iconColor' => 'red']);
        else {
            try {
                Event::create([
                    'title' => $this->title,
                ...
                $this->dispatchBrowserEvent('updated', ['title' => 'Berhasil Menambahkan Acara', 'icon' => 'success', 'iconColor' => 'green']);
                $this->emit('reloadHalamanAbsensi');
            } catch (\Exception $e) {
