...
class Add extends Component
{
    ...
    public function submit()
    {
        ...
        if (!userHasPermission(PERMISSION_ADD_PENGUMUMAN)) {
            $this->dispatchBrowserEvent('updated', ['title' => 'Kamu tidak memiliki akses untuk menambah pengumuman', 'icon' => 'error', 'iconColor' => 'red']);
            return;
        }
        ...
        try {
            ...
            $this->closeModal();
            $this->dispatchBrowserEvent('updated', ['title' => 'Berhasil Menambahkan Pengumuman', 'icon' => 'success', 'iconColor' => 'green']);
            $this->resetForm();
