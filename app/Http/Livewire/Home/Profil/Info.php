...
class Info extends Component
{
    ...
    public function updatedPhoto()
    {
        ...
        $this->dispatchBrowserEvent('updated', ['title' => 'Berhasil mengubah foto profil', 'icon' => 'success', 'iconColor' => 'green']);

        // refresh component foto profile di navbar
        $this->emit('refreshPhotoNavbar');
    }
    ...
    public function render()
    {
        ...
        if (count($this->getErrorBag()->all()) > 0) {
            $this->dispatchBrowserEvent('updated', ['title' => 'Gagal mengubah foto. Pastikan file merupakan file gambar dan tidak lebih dari 2MB', 'icon' => 'error', 'iconColor' => 'red']);
