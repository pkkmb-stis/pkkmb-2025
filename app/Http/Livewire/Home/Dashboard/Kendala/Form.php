...
class Form extends Component
{
    ...
    public function submit()
    {
        ...
        try {
            ...
            $this->dispatchBrowserEvent('updated', ['title' => "Kendala kamu berhasil dikirimkan ke panitia", 'icon' => 'success', 'iconColor' => 'green']);
            $this->emit('refreshListKendala');
        } catch (\Throwable $th) {
            $this->dispatchBrowserEvent('updated', ['title' => "Gagal mengirimkan kendala. Silakan coba lagi", 'icon' => 'error', 'iconColor' => 'red']);
        }
        $this->resetAll();
    }
