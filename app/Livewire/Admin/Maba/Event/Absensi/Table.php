...
class Table extends Component
{
    ...
    public function hapus($user, $link)
    {
        ...
        try {
            ...
            $this->dispatch('updated', 
                title: 'Gagal menghapus data presensi', 
                icon: 'error', 
                iconColor: 'red'
            );
        }
    ...
    #[On('echo-private:absensi,AbsensiUpdated')]
    public function refresh()
    {
        // Magic method $refresh() sekarang menjadi method explicit untuk Laravel Echo listener
    }
