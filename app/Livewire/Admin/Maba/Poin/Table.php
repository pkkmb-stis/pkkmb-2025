    ...
    public function destroy(Poin $poin)
    {
        if (!userHasPermission(PERMISSION_DELETE_POIN)) {
            return $this->dispatch('updated', 
                title: 'Kamu tidak memiliki akses untuk menghapus poin',
                icon: 'error', 
                iconColor: 'red'
            );
        }
