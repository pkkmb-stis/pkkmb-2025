...
class PoinOtomatis extends Component
{
    ...
    private function generatePoin() {
        $count = 0;
        $patuhAtribut = Collection::make();
        $patuhKuliahUmum = Collection::make();
        $patuhHariIni = Collection::make();
        $patuhTugas = Collection::make();
        $patuhAtributPKBN = Collection::make();
        ...
        try {
            ...
            $this->dispatch('reloadTableInputPoin');
